<template>
    <DefaultLayout>
        <div class="mx-auto max-w-7xl">
            ...
            <!-- <ChatCard />\ -->
            <div>
                <TableThree :heads="heads" :lists="packages" :isLoading="true" />
            </div>
        </div>
    </DefaultLayout>

    <BaseModal :show="isCreateModalActive" @close="isCreateModalActive = false" modalTitle="create service category"
        maxWidthValue="500px">
        <Create />
    </BaseModal>
</template>
...
import TableThree from '@/components/Tables/BaseTable.vue';
...
const breadCumbItems = [{ label: 'Services', path: '/services' }]
